"""Run Steepest Descent on f1 from x0 = [1, d] until convergence.
...
from optimization_methods.steepest_descent import steepest_descent
...
def run():
    x0 = [1, D]
    history = steepest_descent(f1, grad_f1, x0, tol=1e-6, max_iter=200000)
